...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("amsterdamcoin://"))
    {
        uri.replace(0, 12, "amsterdamcoin:");
    }
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart)
    {
        ...
        // Get a pointer to the IAmsterdamCoinLink interface.
        IShellLink* psl = NULL;
        ...
        if (SUCCEEDED(hres))
        {
            ...
            // Query IAmsterdamCoinLink for the IPersistFile interface for
